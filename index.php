...
<head>
    ...
    <meta name="author" content="Shiva Kamath, Sreekesh Kamath">
    <meta name="generator" content="Jekyll v3.8.6">
    <title>Covid TImes</title>
...
<body>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1>Why should COVID have all the fun? </h1>
                <p class="lead text-muted">During these uncertain times, life can become a little bit less boring. Check out our free to play games below.</p>
                <p>
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href = "/pacman-canvas" class="btn btn-success">Play Now!</a>
                                        <!-- <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button> -->
                                    </div>
                                    <small class="text-muted">1.2K Plays</small>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="js/jquery-3.4.1.slim.min.js.download" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ+n" crossorigin="anonymous"></script>
    <script>
